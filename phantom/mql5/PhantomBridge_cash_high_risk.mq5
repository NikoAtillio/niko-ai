//+----+
//|               PhantomBridge_cash_high_risk.mq5                    |
//|  CASH/LIVE-HARDCODED FORK of PhantomBridge_v2                    |
...
//+----+
#property strict
#property description "PHANTOM p2 bridge (CASH HIGH RISK) - reads phantom_signals.jsonl and mirrors Python signals"
...
input string  InpLogFile             = "phantom_bridge_high_risk_log.csv";
