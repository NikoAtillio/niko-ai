#//+------------------------------------------------------------------+
//|                                          Phantom_P2_US100_V8B.mq5 |
//|                                    Multi-Timeframe Zone Strategy  |
//|                                             US100 Scenario B      |
//+------------------------------------------------------------------+
//  V8B changelog (renamed from V5):
//    - File renamed from mql5_v5_ftmo.mq5 to mql5_v8b_ftmo.mq5 for V8B development.
//    - Content is identical to the V5 baseline (EWM ATR sprint) and preserved here
//      to serve as the V8B branch for experiments and gating changes.
//    - Preserved V5 notes below (EWM ATR seeding, alpha, warm-up guard, validation logging).
//+------------------------------------------------------------------+
#property copyright "Phantom P2 MT5"
#property version   "8.00"
#property description "Multi-Timeframe Zone-Based Strategy for US100"
#property description "Scenario B - V8B (renamed from V5)"
