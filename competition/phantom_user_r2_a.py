...
SWEEP_TICK_MAX       = 12.0        # max sweep — larger = messy, not a trap
WICK_RATIO_MIN       = 0.50       # wick must be >= 55% of candle range

# Layer 3 — Volume
VOLUME_MULT          = 1.2        # trap candle volume >= 1.4x 20-bar avg
