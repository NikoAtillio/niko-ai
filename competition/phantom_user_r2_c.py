...
SWEEP_TICK_MAX       = 18.0        # max sweep — larger = messy, not a trap
WICK_RATIO_MIN       = 0.45       # wick must be >= 55% of candle range

# Layer 3 — Volume
VOLUME_MULT          = 1.10        # trap candle volume >= 1.4x 20-bar avg
