...
variable already defined	phantom_signal_reader_v3.mq5	816	14
   see declaration of variable 'InpMinHoldHours'	phantom_signal_reader_v3.mq5	24	14
idenfitier 'InpMinHoldHours' already used	phantom_signal_reader_v3.mq5	24	14
   see declaration of variable 'InpMinHoldHours'	phantom_signal_reader_v3.mq5	24	14
idenfitier 'SIGNAL_MODE_REPLAY' already used	phantom_signal_reader_v3.mq5	820	5
   see declaration of 'SignalMode::SIGNAL_MODE_REPLAY'	phantom_signal_reader_v3.mq5	28	5
idenfitier 'SIGNAL_MODE_LIVE' already used	phantom_signal_reader_v3.mq5	821	5
   see declaration of 'SignalMode::SIGNAL_MODE_LIVE'	phantom_signal_reader_v3.mq5	29	5
idenfitier 'SignalMode' already used	phantom_signal_reader_v3.mq5	818	6
   see declaration of enum 'SignalMode'	phantom_signal_reader_v3.mq5	26	6
variable already defined	phantom_signal_reader_v3.mq5	824	18
   see declaration of variable 'InpSignalMode'	phantom_signal_reader_v3.mq5	32	18
idenfitier 'InpSignalMode' already used	phantom_signal_reader_v3.mq5	32	18
   see declaration of variable 'InpSignalMode'	phantom_signal_reader_v3.mq5	32	18
variable already defined	phantom_signal_reader_v3.mq5	827	8
   see declaration of variable 'trade'	phantom_signal_reader_v3.mq5	35	8
idenfitier 'trade' already used	phantom_signal_reader_v3.mq5	35	8
   see declaration of variable 'trade'	phantom_signal_reader_v3.mq5	35	8
variable already defined	phantom_signal_reader_v3.mq5	829	5
   see declaration of variable 'g_lastLineCount'	phantom_signal_reader_v3.mq5	37	5
idenfitier 'g_lastLineCount' already used	phantom_signal_reader_v3.mq5	37	5
   see declaration of variable 'g_lastLineCount'	phantom_signal_reader_v3.mq5	37	5
idenfitier 'SignalRecord' already used	phantom_signal_reader_v3.mq5	831	8
   see declaration of struct 'SignalRecord'	phantom_signal_reader_v3.mq5	39	8
variable already defined	phantom_signal_reader_v3.mq5	846	14
   see declaration of variable 'g_signals'	phantom_signal_reader_v3.mq5	54	14
idenfitier 'g_signals' already used	phantom_signal_reader_v3.mq5	54	14
   see declaration of variable 'g_signals'	phantom_signal_reader_v3.mq5	54	14
variable already defined	phantom_signal_reader_v3.mq5	847	5
   see declaration of variable 'g_nextSignalIndex'	phantom_signal_reader_v3.mq5	55	5
idenfitier 'g_nextSignalIndex' already used	phantom_signal_reader_v3.mq5	55	5
   see declaration of variable 'g_nextSignalIndex'	phantom_signal_reader_v3.mq5	55	5
variable already defined	phantom_signal_reader_v3.mq5	848	10
   see declaration of variable 'g_lastReplayBarTime'	phantom_signal_reader_v3.mq5	56	10
idenfitier 'g_lastReplayBarTime' already used	phantom_signal_reader_v3.mq5	56	10
   see declaration of variable 'g_lastReplayBarTime'	phantom_signal_reader_v3.mq5	56	10
variable already defined	phantom_signal_reader_v3.mq5	849	8
   see declaration of variable 'g_referenceAccountSize'	phantom_signal_reader_v3.mq5	57	8
idenfitier 'g_referenceAccountSize' already used	phantom_signal_reader_v3.mq5	57	8
   see declaration of variable 'g_referenceAccountSize'	phantom_signal_reader_v3.mq5	57	8
idenfitier 'PositionMeta' already used	phantom_signal_reader_v3.mq5	851	8
   see declaration of struct 'PositionMeta'	phantom_signal_reader_v3.mq5	59	8
variable already defined	phantom_signal_reader_v3.mq5	866	14
   see declaration of variable 'm_positions'	phantom_signal_reader_v3.mq5	74	14
idenfitier 'm_positions' already used	phantom_signal_reader_v3.mq5	74	14
   see declaration of variable 'm_positions'	phantom_signal_reader_v3.mq5	74	14
variable already defined	phantom_signal_reader_v3.mq5	867	5
   see declaration of variable 'm_posCount'	phantom_signal_reader_v3.mq5	75	5
idenfitier 'm_posCount' already used	phantom_signal_reader_v3.mq5	75	5
   see declaration of variable 'm_posCount'	phantom_signal_reader_v3.mq5	75	5
'GetVolumeSpec' - function already defined and has body	phantom_signal_reader_v3.mq5	869	6
   see declaration of function 'GetVolumeSpec'	phantom_signal_reader_v3.mq5	77	6
'OpenSignalFile' - function already defined and has body	phantom_signal_reader_v3.mq5	897	5
   see declaration of function 'OpenSignalFile'	phantom_signal_reader_v3.mq5	105	5
'AdjustVolume' - function already defined and has body	phantom_signal_reader_v3.mq5	906	8
   see declaration of function 'AdjustVolume'	phantom_signal_reader_v3.mq5	114	8
'GetUnitsPerLot' - function already defined and has body	phantom_signal_reader_v3.mq5	929	8
   see declaration of function 'GetUnitsPerLot'	phantom_signal_reader_v3.mq5	137	8
'MapPythonQtyToLots' - function already defined and has body	phantom_signal_reader_v3.mq5	941	8
   see declaration of function 'MapPythonQtyToLots'	phantom_signal_reader_v3.mq5	149	8
'MinValidVolume' - function already defined and has body	phantom_signal_reader_v3.mq5	976	8
   see declaration of function 'MinValidVolume'	phantom_signal_reader_v3.mq5	184	8
'EffectiveAtrEntry' - function already defined and has body	phantom_signal_reader_v3.mq5	988	8
   see declaration of function 'EffectiveAtrEntry'	phantom_signal_reader_v3.mq5	196	8
'CurrentReplayTime' - function already defined and has body	phantom_signal_reader_v3.mq5	997	10
   see declaration of function 'CurrentReplayTime'	phantom_signal_reader_v3.mq5	205	10
'SortSignalsByTime' - function already defined and has body	phantom_signal_reader_v3.mq5	1005	6
   see declaration of function 'SortSignalsByTime'	phantom_signal_reader_v3.mq5	213	6
'_trim_copy' - function already defined and has body	phantom_signal_reader_v3.mq5	1021	8
   see declaration of function '_trim_copy'	phantom_signal_reader_v3.mq5	229	8
'_get_json_string' - function already defined and has body	phantom_signal_reader_v3.mq5	1046	8
   see declaration of function '_get_json_string'	phantom_signal_reader_v3.mq5	254	8
'_get_json_number' - function already defined and has body	phantom_signal_reader_v3.mq5	1070	8
   see declaration of function '_get_json_number'	phantom_signal_reader_v3.mq5	278	8
'_parse_signal_time' - function already defined and has body	phantom_signal_reader_v3.mq5	1077	10
   see declaration of function '_parse_signal_time'	phantom_signal_reader_v3.mq5	285	10
'_append_signal' - function already defined and has body	phantom_signal_reader_v3.mq5	1087	6
   see declaration of function '_append_signal'	phantom_signal_reader_v3.mq5	295	6
'FindPositionTicketByComment' - function already defined and has body	phantom_signal_reader_v3.mq5	1094	7
   see declaration of function 'FindPositionTicketByComment'	phantom_signal_reader_v3.mq5	302	7
'ModifyPositionByTicket' - function already defined and has body	phantom_signal_reader_v3.mq5	1111	6
   see declaration of function 'ModifyPositionByTicket'	phantom_signal_reader_v3.mq5	319	6
'ClosePositionByTicket' - function already defined and has body	phantom_signal_reader_v3.mq5	1137	6
   see declaration of function 'ClosePositionByTicket'	phantom_signal_reader_v3.mq5	345	6
'RegisterOpenPosition' - function already defined and has body	phantom_signal_reader_v3.mq5	1174	6
   see declaration of function 'RegisterOpenPosition'	phantom_signal_reader_v3.mq5	382	6
'ManageTrailingStops' - function already defined and has body	phantom_signal_reader_v3.mq5	1195	6
   see declaration of function 'ManageTrailingStops'	phantom_signal_reader_v3.mq5	403	6
'LoadSignals' - function already defined and has body	phantom_signal_reader_v3.mq5	1277	6
   see declaration of function 'LoadSignals'	phantom_signal_reader_v3.mq5	485	6
'CountLines' - function already defined and has body	phantom_signal_reader_v3.mq5	1320	5
   see declaration of function 'CountLines'	phantom_signal_reader_v3.mq5	528	5
'ProcessLine' - function already defined and has body	phantom_signal_reader_v3.mq5	1337	6
   see declaration of function 'ProcessLine'	phantom_signal_reader_v3.mq5	545	6
'ProcessSignalsLive' - function already defined and has body	phantom_signal_reader_v3.mq5	1461	6
   see declaration of function 'ProcessSignalsLive'	phantom_signal_reader_v3.mq5	665	6
'ProcessSignalsReplay' - function already defined and has body	phantom_signal_reader_v3.mq5	1504	6
   see declaration of function 'ProcessSignalsReplay'	phantom_signal_reader_v3.mq5	708	6
'OnInit' - function already defined and has body	phantom_signal_reader_v3.mq5	1537	5
   see declaration of function 'OnInit'	phantom_signal_reader_v3.mq5	741	5
'OnTick' - function already defined and has body	phantom_signal_reader_v3.mq5	1568	6
   see declaration of function 'OnTick'	phantom_signal_reader_v3.mq5	772	6
'OnTimer' - function already defined and has body	phantom_signal_reader_v3.mq5	1578	6
   see declaration of function 'OnTimer'	phantom_signal_reader_v3.mq5	782	6
'OnDeinit' - function already defined and has body	phantom_signal_reader_v3.mq5	1583	6
   see declaration of function 'OnDeinit'	phantom_signal_reader_v3.mq5	787	6
69 errors, 0 warnings		69	0
...
void ManageTrailingStops()
{
    ...
    for(int i = m_posCount - 1; i >= 0; i--)
    {
        ...
        if(initialRisk > 0.0)
        {
            currentR = isLong ? (currentPrice - entryPrice) / initialRisk
        ...
        if(!m_positions[i].be_triggered && initialRisk > 0.0 && currentR >= InpBreakevenR)
        {
            ...
            if(InpVerboseLog)
                PrintFormat("[BREAKEVEN] Ticket %d: moved stop to entry (%.5f)", m_positions[i].ticket, entryPrice);
        ...
        if(MathAbs(m_positions[i].current_stop - currentStop) > pointValue)
        {
            if(InpVerboseLog)
                PrintFormat("[TRAIL] Ticket %d: SL %.5f -> %.5f (Age: %.1f hrs, R: %.2f)",
                            m_positions[i].ticket, currentStop, m_positions[i].current_stop, ageHours, currentR);
...
void LoadSignals()
{
    ...
    while(!FileIsEnding(handle))
    {
        ...
        signal.atr_entry = _get_json_number(line, "atr_entry");
...
void ProcessLine(const string &line)
{
    ...
    double atrEntry = _get_json_number(cleaned, "atr_entry");
