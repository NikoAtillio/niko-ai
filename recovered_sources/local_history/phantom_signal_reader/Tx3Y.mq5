...
int OnInit()
{
    ...
    g_lastLineCount = InpReplayExistingSignals ? 0 : CountLines(InpSignalFile);
    PrintFormat("phantom_signal_reader initialized | magic=%d | replay=%s | start_line=%d", InpMagicNumber, InpReplayExistingSignals ? "true" : "false", g_lastLineCount);
