...
- Variants compared per instrument: `P1A`, `P1B`, `P1C`, `P2A`, `P2B`, `P2C`.
...
- US100: `P2C` (best efficiency, strong return, controlled DD)
...
Practical mapping:
- For BTCUSD/US100/XAUUSD, use `P2A/P2C/P2B`.
